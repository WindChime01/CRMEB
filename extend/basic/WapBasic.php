...
class WapBasic extends Controller
{
    ...
    public function serRedisPwd($msg)
    {
        if (strpos($msg, 'username-password pair') !== false) {
            return $this->failed('请检查redis密码!', 'https://doc.crmeb.com/zsff/crmeb_zsff_v2/6328');
            ...
            return $this->failed('redis认证错误!', 'https://doc.crmeb.com/zsff/crmeb_zsff_v2/6329');
        } elseif (strpos($msg, 'not support: redis') !== false) {
            return $this->failed('请安装redis扩展!', 'https://doc.crmeb.com/zsff/crmeb_zsff_v2/6212');
        } elseif (strpos($msg, 'ERR AUTH <password> called without any password configured for the default user') !== false) {
            return $this->failed('请设置redis密码!', 'https://doc.crmeb.com/zsff/crmeb_zsff_v2/6328');
        } else {
