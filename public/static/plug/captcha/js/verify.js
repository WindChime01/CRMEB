...
;(function($, window, document,undefined) {
    ...
    Slide.prototype = {
        init: function() {
        	...
        	if(this.options.mode == 'pop')	{
				...
				_this.$element.find('.verifybox-close').on('click', function() {
					_this.$element.find(".verifymask").css("display","none");
					_this.refresh();
				});
				...
				clickBtn && (clickBtn.onclick = function(){
					if (_this.options.beforeCheck()) {
                        if (!_this.options.beforeShow()) {
                            return
                        }
						_this.$element.find(".verifymask").css("display","block");
					}
				})
        	}
        ...
        loadDom : function() {
			...
			wrapStartHtml = '<div class="verifymask">'+
								'<div class="verifybox" style="width:'+(parseInt(this.setSize.img_width)+30)+'px">'+
									'<div class="verifybox-top">'+
										'请完成安全验证'+
										'<span class="verifybox-close">'+
											'<i class="iconfont-verify icon-close"></i>'+
										'</span>'+
									'</div>'+
			...
			panelHtml +='<div class="verify-bar-area" style="width:'+this.setSize.img_width+',height:'+this.setSize.bar_height+',line-height:'+this.setSize.bar_height+'">'+
									...
									'<div class="verify-left-bar">'+
										...
										'<div  class="verify-move-block">'+
											'<i  class="verify-icon iconfont-verify icon-right"></i>'+
        ...
        refresh: function() {
			...
			getPictrue({captchaType:"blockPuzzle", clientUid: localStorage.getItem('slider'), ts: Date.now()},this.options.baseUrl,function (res) {
				if (res.code==200) {
					...
					_this.$element.find(".backImg")[0].src = '../../static/plug/captcha/images/default.jpg'
