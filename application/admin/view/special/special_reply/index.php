...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">专题评论</div>
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <label class="layui-form-label">专题信息</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="special_name" class="layui-input" placeholder="专题名称、编号">
                                </div>
                            </div>
                            <div class="layui-inline">
                                <label class="layui-form-label">用户UID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="title" class="layui-input" placeholder="UID">
                                </div>
                            </div>
                            <div class="layui-inline">
                ...
                <div class="layui-col-md12">
                    <div class="layui-btn-group">
                        <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" data-type="add" onclick="action.open_add('{:Url('create_false')}?special_id='+special_id,'添加虚拟评论')">
...
<script>
    ...
    layList.tableList('List',"{:Url('getSpecialReplyList')}?special_id="+special_id,function (){
        return [
                ...
                {field: 'title', title: '专题名称', width:'14%',align:'center', style:'word-break:break-all;'},
                {field: 'satisfied_score', title: '满意评分', width:'6%',align:'center'},
                {field: 'comment', title: '评论内容', toolbar:'#comment', style:'word-break:break-all;'},
                {field: 'merchant_reply_content', title: '回复内容', align:'center', style:'word-break:break-all;'},
                {field: 'is_selected', title: '加精', align:'center',width:'7%',toolbar:'#is_selected'},
                {field: 'add_time', title: '评论时间',align:'center',width:'12%'},
                {field: 'right', title: '操作',align:'center',minWidth:135,toolbar:'#act',width:'10%'}
            ];
    });
    //自定义方法
    var action= {
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            ...
            case 'reply':
                ...
                $eb.$alert('textarea',{title:'请添加回复内容',value:make, inputAttributes: {
                    maxlength: 100
                },inputPlaceholder:'100字以内'},function (result) {
                    if(result){
                        $.ajax({
                            url:url,
