                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入专题名称" maxlength="30" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <select name="subject_id" v-model="formData.subject_id" lay-search="" lay-filter="subject_id">
                                        ...
                                        <option v-for="item in subject_list" :value="item.id" :disabled="item.grade_id==0 ? true : false">{{item.html}}{{item.name}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model="link" style="width:300px;display:inline-block;margin-right: 10px;" autocomplete="off"
                                    ...
                                    <div class="layui-form-mid layui-word-aux" style="float: none;display: inline-block;">输入链接将视为添加视频直接添加,请确保视频链接的正确性
                                    </div>
                                </div>
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <div class="layui-form-mid layui-word-aux" style="float: none;display: inline-block;">如果素材列表中没有你要的素材，请：<a @click='add_source'
                                           style="color: #0093dd;">前往添加素材</a></div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="sum" lay-verify="sum" v-model="formData.sum" autocomplete="off" class="layui-input" min="0" max="99999">
                                </div>
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" v-show="formData.is_alone == 1">
                                ...
                                <div class="layui-input-block">
                                    <input style="width: 300px" type="number" name="brokerage_ratio" lay-verify="number" min="0" v-model="formData.brokerage_ratio"
