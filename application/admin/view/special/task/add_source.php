    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <form action="" class="layui-form" lay-filter="taskForm">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label required">素材名称：</label>
                    <div class="layui-input-block">
                        <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入素材名称" maxlength="50" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item required">
                    ...
                    <div class="layui-input-inline">
                        <div class="upload-picture-card">
                            ...
                            <div v-else class="upload-picture" @click="upload('image')">
                ...
                <div class="layui-form-item"  v-show="source_type==3">
                    <label class="layui-form-label">素材链接：</label>
                    <div class="layui-input-block">
                        ...
                        <button v-show="is_upload==false" type="button" class="layui-btn layui-btn-normal layui-btn-sm ossupload" id="ossupload_video">上传视频</button>
                ...
                <div class="layui-form-item"  v-show="source_type==2">
                    ...
                    <div class="layui-input-block">
                        ...
                        <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" @click="confirmAdd" v-show="is_upload==false">确认添加</button>
                        <button v-show="is_upload==false" type="button" class="layui-btn layui-btn-normal layui-btn-sm ossupload" id="ossupload_audio">上传音频</button>
                        <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" v-show="is_upload" @click="delVideo()">删除</button>
                        <button v-show="link" type="button" class="layui-btn layui-btn-warm layui-btn-sm" @click="previewSource">预览</button>
                    </div>
                    <div class="layui-input-block" style="width: 50%;margin-top: 20px" v-show="is_video">
...
{block name='script'}
<script>
    var id={$id},special_id={$special_id},alicloud_account_id="{$alicloud_account_id}",configuration_item_region="{$configuration_item_region}",demand_switch="{$demand_switch}",
        ...
        new Vue({
            ...
            data: {
                formData:{
                    ...
                    sort:special.sort || 0,
                    pid:special.pid || 0,
                    special_id:special.special_id || special_id,
            ...
            methods:{
                ...
                confirmAdd: function () {
                    if (this.link) {
                        if (/^https?:\/\/(.+\/)+.+(\.(m3u8|mp4|mp3))$/i.test(this.link)) {
                            ...
                            layui.layer.msg('请输入正确的' + (this.source_type == 2 ? '音' : '视') + '频链接', {icon: 5});
                        }
                    }
                },
                ...
                save:function () {
                    ...
                    if(!that.formData.title) return layList.msg('请输入素材名称');
                    ...
                    if (that.source_type == 1) {
                        ...
                        if (!that.formData.content) {
                            return layList.msg('请编辑素材内容');
                        }
                    }
                    if (!that.formData.detail) {
                        return layList.msg('请编辑素材简介');
                    }
                    layList.loadFFF();
                ...
                audio_video_upload:function () {
                    ...
                    that.uploader = ossUpload.upload({
                        id: that.source_type == 2 ? 'ossupload_audio' : 'ossupload_video',
                        mime_types: [
                            that.source_type == 2 ? {title: "Mp3 files", extensions: "mp3"} : {title: "Mp4 files", extensions: "mp4,m3u8"}
                        ],
                ...
                layList.form.on('radio(source_type)', function (data) {
                    ...
                    if(that.demand_switch=='1') {
                        that.uploadInst.reload({
                            accept: that.source_type == 2 ? 'audio' : 'video',
                            acceptMime: that.source_type == 2 ? 'audio/mp3' : 'video/mp4,video/m3u8',
                            exts: that.source_type == 2 ? 'mp3' : 'mp4|m3u8'
                        });
                    }
