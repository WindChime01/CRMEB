            ...
            <div class="layui-row layui-col-space15">
                ...
                <div class="layui-col-md12">
                    ...
                    <script type="text/html" id="quantity">
                        <p style="font-size: 6px">已选:{{d.quantity}}</p>
                        <a  href="javascript:void(0)" class="layui-badge layui-bg-blue" onclick="$eb.createModalFrame('查看专题','{:Url('special_material')}?id='+{{d.id}}+'&special_type=5'+'&order='+{{d.sort_order}},{w:1200,h:800})">
                            查看专题
                        </a>
                    </script>
...
<script>
    ...
    }},"{:Url('list',['special_type'=>$special_type])}",function (){
        return [
            ...
            {field: 'quantity', title: '已选专题',align: 'center',width:'7%',templet:'#quantity'},
