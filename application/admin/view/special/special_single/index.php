                ...
                <div class="layui-col-md12">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a  href="javascript:void(0)" onclick="action.open_add('{:Url('single_add')}?id={{d.id}}&special_type={$special_type}','编辑专题')">
                                    <i class="iconfont icon-bianji"></i> 编辑专题
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.title}}-专题转赠','{:Url('increase')}?special_id={{d.id}}',{h:600,w:500})">
...
<script>
    ...
    layList.tableList({o:'List', done:function () {
        ...
        return [
            {field: 'id', title: '编号', width:'7%',align: 'center'},
