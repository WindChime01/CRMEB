                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="account" required  value="{$account}" lay-verify="required" placeholder="请输入账号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="password" name="password" required value="{$password}" lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
        ...
        form.on('submit(*)', function(data){
            $eb.axios.post("{:Url('go_login')}", data.field).then(function (res) {
                if (res.status == 200 && res.data.code == 200) {
                    ...
                    window.location.href = "{:url('setting.systemPlat/"+str+"')}";
                } else {
