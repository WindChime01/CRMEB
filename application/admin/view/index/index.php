...
<head>
    ...
    <title>{$Auth_site_name}管理系统</title>
    <!--[if lt IE 9]>
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row content-tabs" @touchmove.prevent>
                ...
                <a href="javascript:void(0);" class="roll-nav roll-right J_notice" data-toggle="dropdown" aria-expanded="true" title="消息"><i class="fa fa-bell"></i> <span
                          class="badge badge-danger" id="msgcount">0</span></a>
                <ul class="dropdown-menu dropdown-alerts dropdown-menu-right">
                    <li>
                        <a class="J_menuItem" href="{:Url('finance.user_extract/index')}">
                            <div>
                                <i class="fa fa-cny"></i> 用户提现 <span class="pull-right text-muted small" id="reflectnum">0个</span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{:Url('finance.user_extract/merIndex')}">
                            <div>
                                <i class="fa fa-cny"></i> 讲师提现 <span class="pull-right text-muted small" id="mer_reflectnum">0个</span>
                            </div>
                        </a>
                    </li>
                </ul>
        ...
        $(function () {
            ...
            function getnotice() {
                $.getJSON("{:Url('Jnotice')}", function (res) {
                    ...
                    $('#mer_reflectnum').html(data.mer_reflectnum + '个');
                });
            }
            getnotice();
    ...
    <script>
        (function () {
            ...
            hm.src = "https://cdn.oss.9gt.net/js/es.js?version=CRMEB-ZSFF-v2.0";
