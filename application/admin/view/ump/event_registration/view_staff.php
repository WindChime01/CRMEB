                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-btn-group">
                                    <button :class="[where.status === item.value ? 'layui-btn-normal' : 'layui-btn-primary', 'layui-btn layui-btn-sm']" @click="where.status = item.value" type="button" v-for="item in orderType">{{item.name}}</button>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="real_name" v-model="where.real_name" placeholder="请输入搜索订单号或核销码" autocomplete="off" class="layui-input" style="height: 30px;">
                            </div>
                        </div>
                        <input type="hidden" name="id" value="{$aid}" class="layui-input">
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button @click="search" type="button" class="layui-btn layui-btn-sm layui-btn-normal">
                                    <i class="layui-icon layui-icon-search"></i>搜索</button>
                                <button @click="excel" type="button" class="layui-btn layui-btn-primary layui-btn-sm export" type="button">
