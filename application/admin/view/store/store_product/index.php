            ...
            <div class="layui-row layui-col-space15">
                ...
                <div class="layui-col-md12">
                    ...
                    <script type="text/html" id="image">
                        <img width="50" height="50" lay-event="open_image" src="{{d.image}}">
                    </script>
                    <!--上架|下架-->
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.title}}-商品转增','{:Url('increase')}?id={{d.id}}',{h:600,w:500})">
                                    <i class="iconfont icon-yidongshouye"></i> 商品转增
                                </a>
                            </li>
                            <li>
        ...
        switch (parseInt(type)){
            case 1:case 3:case 4:case 5:
                join=[
                    ...
                    {field: 'image', title: '图片',templet:'#image',align: 'center',minWidth:80,width:'8%'},
                    ...
                    {field: 'status', title: '状态',templet:"#checkboxstatus",align: 'center',minWidth:92,width:'8%'},
