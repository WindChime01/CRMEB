    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <div class="layui-btn-container">
                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="$eb.createModalFrame('添加订阅消息','{:Url('create')}')"><i class="layui-icon layui-icon-add-1"></i>添加订阅消息</button>
            </div>
