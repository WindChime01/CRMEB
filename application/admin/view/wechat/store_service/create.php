                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="nickname" lay-verify="nickname" style="width: 100%" autocomplete="off" placeholder="请输入姓名、编号、手机号"
                                                   class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
...
<script>
    ...
    layList.tool(function (event, data) {
        ...
        switch (layEvent) {
            case 'add_student':
                var url = layList.U({a: 'save', q: {uid: data.uid}});
                layer.confirm('确定设置该用户为客服吗？', {
                    btn: ['确定', '取消'] //按钮
                }, function () {
                    $.ajax({
                        url: url,
                        ...
                        error: function (err) {
                            layer.msg(err.msg, {icon: 5}, function () {
                                layer.closeAll();
                            });
                        }
                    })
