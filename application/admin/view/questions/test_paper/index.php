        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="act">
                ...
                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                    ...
                    <li>
                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.title}}-推荐管理','{:Url('web_recommend')}?test_id={{d.id}}',{h:300,w:400})">
    ...
    layList.tableList({o:'List', done:function () {
            ...
            $('.layui-btn-yd').on('click', function (event) {
                ...
                if ('recommend' === type) {
                    ...
                    var url = layList.U({ a: 'cancel_recommendation', q: { id: id, test_id: pid } });
                    $eb.$swal(
                        'delete',
                        function () {
                            $eb.axios
            ...
            $('.layui-btn-pc').on('click', function (event) {
                ...
                if ('recommend' === type) {
                    var id = target.dataset.id;
                    var pid = target.dataset.pid;
                    var url = layList.U({ a: 'cancel_web_recommendation', q: { id: id, test_id: pid } });
                    $eb.$swal(
                        'delete',
                        function () {
                            $eb.axios
        ...
        }},"{:Url('getTestPaperExercisesList',['type'=>$type])}",function (){
        var join=new Array();
