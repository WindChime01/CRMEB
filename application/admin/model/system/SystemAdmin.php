...
class SystemAdmin extends ModelBasic
{
    ...
    {
        $adminInfo = self::where(['account' => $account, 'is_del' => 0])->find();
    ...
    public static function setLoginInfo($adminInfo)
    {
        ...
        Session::set('adminId', $adminInfo['id'], 'admin');
    ...
    {
        return Session::has('adminId', 'admin') && Session::has('adminInfo', 'admin');
    }
    ...
    {
        $adminInfo = Session::get('adminInfo', 'admin');
    ...
    {
        $adminId = Session::get('adminId', 'admin');
