                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="sort" required lay-verify="required|number|integer" autocomplete="off" class="layui-input" v-model.number="formData.sort">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">限购：</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="restrictions" required lay-verify="required|number|integer" autocomplete="off" class="layui-input" v-model.number="formData.restrictions">
                                </div>
