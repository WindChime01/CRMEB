...
<script>
    ...
    //加载列表
    layList.tableList({o:'List', done:function () {}},"{:Url('live_store_list',['live_id'=>$live_id])}",function (){
        return [
    ...
    var action= {
        ...
        open_special_add: function (title) {
            var url = "{:Url('special.special_type/store_task')}?special_id=" + special_id;
            layer.open({
                type: 2 //Page层类型
                ,area: ['80%', '90%']
                ,title: '关联商品'
                ...
                yes: function(){
                    ...
                    layList.baseGet(layList.Url({
                        a: 'add_live_special',
                        q: {special_id: special_id, ids: ids, type: 1}
                    }), function (res) {
