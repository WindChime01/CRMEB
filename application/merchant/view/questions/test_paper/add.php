            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <button v-show="(type == 1 && tabIndex != 1) || (type == 2 && tabIndex != 2)" type="button" class="layui-btn layui-btn-normal" @click="tabChange(1)">下一步</button>
                        <button v-show="(type == 1 && tabIndex == 1) || (type == 2 && tabIndex == 2)" type="button" class="layui-btn layui-btn-normal" @click="save">{$id ?'确认修改':'立即提交'}</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                show_single_list:function () {
                    ...
                    table.render({
                        ...
                        ,cols: [[
                            ...
                            {field: 'sort', title: '排序/倒序(以整套试卷排列)',width:200,edit:'sort',align: 'center'},
