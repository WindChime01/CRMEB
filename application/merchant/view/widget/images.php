        ...
        <div class="layui-fluid-main">
            <div class="main-header">
                <div class="layui-btn-group">
                    <button :class="{ 'layui-btn-normal': selectedImage.length, 'layui-btn-disabled': !selectedImage.length }" type="button" class="layui-btn layui-btn-sm"
                            @click="useImage">使用选中的图片</button>
                    ...
                    <button :class="{ 'layui-btn-normal': selectedImage.length, 'layui-btn-disabled': !selectedImage.length }" type="button" class="layui-btn layui-btn-sm"
                            @click="moveCategory">图片移至</button>
                    <button :class="{ 'layui-btn-danger': selectedImage.length, 'layui-btn-disabled': !selectedImage.length }" type="button" class="layui-btn layui-btn-sm"
                            @click="deleteImage">删除图片</button>
    ...
    new Vue({
        ...
        methods: {
            ...
            U: function (opt) {
                ...
                return layList.U({m: 'merchant', c: "widget.images", a: opt.a || '', q: opt.q || {}, p: opt.q || {}});
            },
            //获取分类
