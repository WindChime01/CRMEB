                ...
                <div class="layui-tab layui-tab-brief" lay-filter="tab">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model.trim="formData.title" autocomplete="off"
                                           placeholder="请输入专题名称" maxlength="30" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <select name="subject_id" v-model="formData.subject_id" lay-search=""
                                        ...
                                        <option v-for="item in subject_list" :value="item.id"
                                                :disabled="item.grade_id==0 ? true : false">{{item.html}}{{item.name}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" v-model="label" name="price_min" placeholder="最多6个字"
                            ...
                            <div v-if="formData.label.length" class="layui-form-item">
                                <div class="layui-input-block">
                                    <button v-for="(item,index) in formData.label" :key="index" type="button"
                                            class="layui-btn layui-btn-normal layui-btn-sm" @click="delLabel(index)">
                                        {{item}}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item required">
                                <label class="layui-form-label">专题Banner：（750*420）</label>
                                <div class="layui-input-block">
                                    ...
                                    <div class="upload-image" v-show="formData.banner.length < 5"
                                         @click="upload('banner',5 - formData.banner.length)">
                                        <div class="fiexd"><i class="fa fa-plus"></i></div>
                                        <p>选择图片</p>
                                    </div>
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <div class="layui-form-mid layui-word-aux"
                                         style="float: none;display: inline-block;">输入链接将视为添加视频直接添加,请确保视频链接的正确性
                                    </div>
                                </div>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                <label class="layui-form-label">素材排序方式：</label>
                                <div class="layui-input-block">
                                    <input type="radio" name="sort_order" lay-filter="sort_order" v-model="formData.sort_order"  value="1" title="正序">
                                    <input type="radio" name="sort_order" lay-filter="sort_order" v-model="formData.sort_order"  value="0" title="倒序">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="validity" lay-verify="number" v-model="formData.validity"
                                           autocomplete="off" class="layui-input" min="0" max="99999">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="is_mer_visible" lay-filter="is_mer_visible"
                                           v-model="formData.is_mer_visible" value="1" title="是">
                                    <input type="radio" name="is_mer_visible" lay-filter="is_mer_visible"
                                           v-model="formData.is_mer_visible" value="0" title="否">
                                </div>
                            </div>
                        </div>
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" v-show="formData.pay_type == 1">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="money" lay-verify="number" v-model="formData.money"
                            ...
                            <div class="layui-form-item" v-show="formData.member_pay_type == 1">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="member_money" lay-verify="number"
                            ...
                            <div class="layui-form-item" v-show="formData.is_pink">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" v-model="formData.pink_time" autocomplete="off"
                                           class="layui-input">
                                </div>
    ...
    require(['vue', 'zh-cn', 'request', 'plupload', 'aliyun-oss', 'OssUpload'], function (Vue) {
        new Vue({
            ...
            methods: {
                ...
                add_source:function(){
                    var that=this;
                    var url="{:Url('special.special_type/addSources')}";
                    var title='添加素材';
                    layer.open({
                        type: 2 //Page层类型
                        ,area: ['80%', '90%']
                        ...
                        cols: [[
                            ...
                            {field: 'sort', title: '排序',edit:'sort',align: 'center'},
                            {
                                field: 'pay_status', title: '状态', align: 'center', templet: function (d) {
                                    var is_checked = d.pay_status == 1 ? "checked" : "";
                                    return "<input type='checkbox' name='pay_status' lay-skin='switch' value='" + d.id + "' lay-filter='pay_status' lay-text='收费|免费' " + is_checked + ">";
                                }
                            },
                            {
