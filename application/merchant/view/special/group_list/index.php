...
<script>
    ...
    //加载列表
    layList.tableList({o:'List', done:function () {}},"{:Url('pink_list')}",function (){
        return [
            {field: 'id', title: '编号',width:'5%',align: 'center'},
            {field: 'title', title: '名称'},
            {field: 'subject_name', title: '分类',align: 'center'},
            {field: 'image', title: '封面',templet:'#image',align: 'center',minWidth:119},
