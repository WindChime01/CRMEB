                ...
                <div class="layui-card-body">
                    <form action="" class="layui-form">
                        <div class="layui-form-item">
                            <label class="layui-form-label required">素材分类名称：</label>
                            <div class="layui-input-block">
                                <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入素材分类名称，10字以内" maxlength="10" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
